...
$string['pluginname'] = 'YeScale Chat Block';
$string['openai_chat'] = 'YeScale Chat';
$string['openai_chat_logs'] = 'YeScale Chat Logs';
$string['openai_chat:addinstance'] = 'Add a new YeScale Chat block';
$string['openai_chat:myaddinstance'] = 'Add a new YeScale Chat block to the My Moodle page';
$string['openai_chat:viewreport'] = 'View YeScale Chat log report';
$string['privacy:metadata:openai_chat_log'] = 'Logged user messages sent to YeScale. This includes the user ID of the user that sent the message, the content of the message, the response from YeScale, and the time that the message was sent.';
...
$string['privacy:metadata:openai_chat_log:airesponse'] = 'The response from YeScale.';
...
$string['apikeydesc'] = 'The API Key for your YeScale account or Azure API key';
...
$string['assistantdesc'] = 'The default assistant attached to your YeScale account that you would like to use for the response';
$string['noassistants'] = 'You haven\'t created any assistants yet. You need to create one <a target="_blank" href="https://platform.openai.com/assistants">in your YeScale account</a> before you can select it here.';
...
$string['resourcenamedesc'] = 'The name of your Azure YeScale Resource.';
...
$string['advanceddesc'] = 'Advanced arguments sent to YeScale. Don\'t touch unless you know what you\'re doing!';
...
$string['config_assistant_help'] = "Choose the assistant you would like to use for this block. More assistants can be created in the YeScale account that this block is configured to use.";
...
$string['defaultassistantname'] = 'YeScale Assistant';
$string['defaultusername'] = 'User';
$string['askaquestion'] = 'Ask a question...';
$string['apikeymissing'] = 'Please add your YeScale API key to the block settings.';
$string['erroroccurred'] = 'An error occurred! Please try again later or contact support at admin@nguyennt.tech.';
...
$string['openaitimedout'] = 'ERROR: YeScale did not provide a response in time.';